...
export const CONTAINER_TIMEOUT = parseInt(process.env.CONTAINER_TIMEOUT || '3600000', 10); // 1 hour default
export const IPC_POLL_INTERVAL = 1000;
export const IDLE_TIMEOUT = parseInt(process.env.IDLE_TIMEOUT || '3300000', 10); // 55min — keep container alive after last result
